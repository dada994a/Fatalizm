...
public class ConfigManager {
    ...
    public static final File ForeverFolder = new File(mc.gameDir, "Fatalizm");
    ...
    public static void saveCurrentConfig() {
        File currentConfig0 = new File("Fatalizm/CurrentConfig.json");
        try {
    ...
    public static String loadCurrentConfig() {
        File currentConfig = new File("Fatalizm/CurrentConfig.json");
