...
public class GuiCustomMainScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new TextButton(1, this.x, this.y + 66, "ClickGui"));
...
//    }
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        } else if (GuiCustomMainScreen.isHovered(this.x - Client.textManager.getStringWidth("ClickGui") / 2, this.y + 66, Client.textManager.getStringWidth("ForeverClient"), Client.textManager.getFontHeight(), mouseX, mouseY)) {
