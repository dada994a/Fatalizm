...
@IFMLLoadingPlugin.Name("fatalizmLoader - 1.0.0")
@IFMLLoadingPlugin.MCVersion("1.12.2")
public class ForeverClientCoreModLoader implements IFMLLoadingPlugin {
    public static final Logger logger = LogManager.getLogger("FatalizmClient");
...
//        AntiDump.check();
//        logger.info("FatalizmrClient is checking HWID...");
//        Authenticator.checkIfValid(true);
        ...
        try {
            ...
            if(devFMLCoreMod != null) DevFMLCoreMod.load();
                ...
                logger.info("FatalizmClient is loading...");
...
//                    logger.info("Loading beta version of FatalizmClient...");
...
//                load(IOUtil.getUrl());
 ...
 //       AntiDump.check();
        MixinBootstrap.init();
        logger.info("FatalizmClient mixins initialize");
        Mixins.addConfiguration("mixins.fatalizm.loader.json");
        MixinEnvironment.getDefaultEnvironment().setObfuscationContext("searge");
        MixinEnvironment.getDefaultEnvironment().setSide(MixinEnvironment.Side.CLIENT);
        logger.info("FatalizmClient mixins initialized");
//        logger.info(MixinEnvironment.getDefaultEnvironment().getObfuscationContext());
        logger.info("FatalizmClient was loaded! Have a nice time with FatalizmClient ;)");
    ...
    public void load(String clientUrl) {
        ...
        try {
            ...
            while (true) {
                ...
                } else if (name.equals("mixins.fatalizm.json")) {
                    MixinCache.mixinBytes = (IOUtils.toByteArray(zosStream));
                } else if (name.equals("mixins.fatalizm.refmap.json")) {
