...
@Mod(modid = "fatalizmclient", name = ForeverClient.MODNAME, version = ForeverClient.MODVER)
public final class ForeverClient {
    public static final String MODNAME = "FatalizmClient";
    public static final String MODVER = "b1.2.3";
...
//        managers.load();
    ...
    public void postInit() {
        ...
        IAS.config = new Configuration(new File("Fatalizm/Alts.json"));
